...
public class CaptureBasic extends JPanel {
    ...
    public static void main(String[] args) {
        try{
            ...
            //    System.out.println("n:"+n);
               ...
               // Imgcodecs.imwrite("G:\\workSoft\\opencv\\faceImage\\back"+n+".png", temp);

               panel.mImg=panel.mat2BI(detectFace(capImg,count));
                panel.repaint();
                //n++;
                //break;
            }
     ...
     * @param img
     */
    public static Mat detectFace(Mat img,int count) throws Exception
    {
       ...
       //不能使用中文路径
        ...
        if(rects != null && rects.length >= 1){
            System.out.println("count:"+count+"if(rects != null && rects.length >= 1) --> true");
